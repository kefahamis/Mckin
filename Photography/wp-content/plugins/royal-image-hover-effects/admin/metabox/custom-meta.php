...
// Tougle Menu
	...
	array(
		...
		'description' => __('To see all styles and effects use the <a target="_blank" href="http://demo.codecans.com/plugins?theme=royal-hover-effects">demo site</a>', 'vp_textdomain'),
		'status' => 'normal',
	),
	...
	// Display Item Appear in One Row
			...
			array(
				...
				'description' => __('<p style="color: #000;">To get Below features working, please buy the pro version only $12</p> </br><a target="_blank" href="http://codecans.com/items/royal-image-hover-effects-pro/"> <span id="buy_now_class"><img style="width: 170px;" src="http://codecans.com/tutorials/images/buy_now.gif" /></span></a>', 'vp_textdomain'),
				'status' => 'normal',
			),
