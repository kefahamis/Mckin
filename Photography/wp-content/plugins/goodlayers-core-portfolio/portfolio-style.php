							...
							switch( $port_info ){
								...
								case 'title':
									...
									if( empty($portfolio_info['title-link-to']) || $portfolio_info['title-link-to'] == 'title' ){
										$overlay_content .= '<span class="gdlr-core-portfolio-title gdlr-core-title-font" ' . gdlr_core_esc_style($port_title_hover_atts) . ' ><a href="' . get_permalink() . '" >' . get_the_title() . '</a></span>';
									}else{
										$overlay_content .= '<span class="gdlr-core-portfolio-title gdlr-core-title-font" ' . gdlr_core_esc_style($port_title_hover_atts) . ' >' . $link_attr['link-tag'] . get_the_title() . '</a></span>';
									}
									break;
